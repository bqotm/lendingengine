package com.peerlender.lendingengine.config;
...
public class MessagingConfig {
    ...
    @Bean
    public MessageListenerAdapter useRegisteredEventListener(UserRegisteredEventHandler userRegisteredEventHandler){
